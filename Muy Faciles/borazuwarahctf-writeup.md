...
![Nmap](../Imagenes/borazuwarah/borazuwarah/1.png)

Abiertos 22 y 80, voy al navegador:

![Huevo](../Imagenes/borazuwarah/borazuwarah/2.png)
...
![exiftool](../Imagenes/borazuwarah/borazuwarah/3.png)

Tengo un usuario, probemos con hydra:

![Hydra](../Imagenes/borazuwarah/borazuwarah/4.png)

Tenemos usuario y contraseña:

![ssh](../Imagenes/borazuwarah/borazuwarah/6.png)

Estamos dentro, probaremos con sudo -l

![bin-bash](../Imagenes/borazuwarah/borazuwarah/7.png)

Pues hay suerte, buso en GTFOBins:

![GFTOBins](../Imagenes/borazuwarah/borazuwarah/8.png)

Lo meto directamente:

![root](../Imagenes/borazuwarah/borazuwarah/9.png)
