...
![nmap](../Imagenes/tproot/tproot/1.png)
...
![exploit](../Imagenes/tproot/tproot/4.png)

Compruebo el numero de sesion, y vuelvo a meterlo, funciona

![sessions](../Imagenes/tproot/tproot/5.png)

Genero un prompt y busco la flag de root

![root](../Imagenes/tproot/tproot/7.png)
